...
const Home = () => {
	return (
		<div>
			<h1>Hello, world!</h1>
			<p>Are you ready to get healthy?</p>
			...
			<ul>
				...
				<li>
					<a href="http://getbootstrap.com/">Bootstrap</a> for layout
					and styling
				</li>
			</ul>
			...
			<ul>
				...
				<li>
					...
					automatically, so your client-side resources are dynamically
					built on demand and the page refreshes when you modify any
					file.
				</li>
				<li>
			...
			<p>
				...
				application based on the <code>create-react-app</code> template.
				If you open a command prompt in that directory, you can run{" "}
